...
#### getTfidf:		Takes in output from getWordCount, returns Tfidf vectors for training classes.
...
#### doTfIdfPrediction:	Takes in test file and output from getTfidf, returns prediction and CCR (if validating).
# Input:
